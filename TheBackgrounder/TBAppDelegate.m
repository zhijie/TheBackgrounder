...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.lauchDate = [NSDate date];

    UIViewController *viewController1 = [[TBFirstViewController alloc] initWithNibName:nil bundle:nil];
    ...
    self.tabBarController.viewControllers = @[nav2, nav1, nav3];
...
- (void)applicationDidBecomeActive:(UIApplication *)application
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:NOTIFICATION_APP_BECOME_ACTIVE object:self];
}
